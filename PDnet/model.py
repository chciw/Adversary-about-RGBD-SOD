...
def customized_acc(y_true,y_pred):
    c=tf.abs(y_pred-y_true)/y_true
    return c

spatial_weight=np.array([[0.06,0.06,0.06],
                         [0.06,0.52,0.06],
                         [0.06,0.06,0.06]])
def spatial_loss(y_true,y_pred):
    print('loss is called')
    w=np.expand_dims(spatial_weight,axis=-1)
    w=np.expand_dims(w,axis=-1)
    w=tf.constant(w,dtype=tf.float32)
    filted=tf.nn.conv2d(y_pred,w,strides=[1,1,1,1],padding='SAME')#[b, h, w, c] [filter_h, filter_w, in_channels, out_channels]
    ...
    #     if 'bias' in v.name:
    #         continue
    #     item=tf.cast(v, dtype=tf.float32)
    #     list.append(item)
    return tf.keras.losses.binary_crossentropy(y_true,y_pred)+0.1*tf.keras.losses.mse(filted,y_pred)
#    return tf.keras.losses.binary_crossentropy(y_true,y_pred)+tf.add_n([tf.nn.l2_loss(item) for item in list])*0.001
...
def vgg161_model(img_width, img_height):
    ...
    outputs_all = Conv2D(1, (3, 3), padding='same', kernel_initializer='TruncatedNormal', activation='sigmoid')(
        concat_out)
...
def vgg16_deep_fuse_model(img_width, img_height):
    ...
    inputs = Input(input_shape)
    # Block 1
    conv1_1 = Conv2D(64, (3, 3), padding='same', name='block1_conv1', trainable=False)(inputs)
    conv1_1 = BatchNormalization(name='batch_normalization_1', trainable=False)(conv1_1)
    conv1_1 = Activation('relu', trainable=False)(conv1_1)
    conv1_2 = Conv2D(64, (3, 3), padding='same', name='block1_conv2', trainable=False)(conv1_1)
    conv1_2 = BatchNormalization(name='batch_normalization_2', trainable=False)(conv1_2)
    conv1_2 = Activation('relu', trainable=False)(conv1_2)
    maxpool1 = MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool', trainable=False)(conv1_2)

    # Block 2
    conv2_1 = Conv2D(128, (3, 3), padding='same', name='block2_conv1', trainable=False)(maxpool1)
    conv2_1 = BatchNormalization(name='batch_normalization_3', trainable=False)(conv2_1)
    conv2_1 = Activation('relu', trainable=False)(conv2_1)
    conv2_2 = Conv2D(128, (3, 3), padding='same', name='block2_conv2', trainable=False)(conv2_1)
    conv2_2 = BatchNormalization(name='batch_normalization_4', trainable=False)(conv2_2)
    conv2_2 = Activation('relu', trainable=False)(conv2_2)
    maxpool2 = MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool', trainable=False)(conv2_2)

    # Block 3
    conv3_1 = Conv2D(256, (3, 3), padding='same', name='block3_conv1', trainable=False)(maxpool2)
    conv3_1 = BatchNormalization(name='batch_normalization_5', trainable=False)(conv3_1)
    conv3_1 = Activation('relu', trainable=False)(conv3_1)
    conv3_2 = Conv2D(256, (3, 3), padding='same', name='block3_conv2', trainable=False)(conv3_1)
    conv3_2 = BatchNormalization(name='batch_normalization_6', trainable=False)(conv3_2)
    conv3_2 = Activation('relu', trainable=False)(conv3_2)
    conv3_3 = Conv2D(256, (3, 3), padding='same', name='block3_conv3', trainable=False)(conv3_2)
    conv3_3 = BatchNormalization(name='batch_normalization_7', trainable=False)(conv3_3)
    conv3_3 = Activation('relu', trainable=False)(conv3_3)
    conv3_4 = Conv2D(256, (3, 3), padding='same', name='block3_conv4', trainable=False)(conv3_3)
    conv3_4 = BatchNormalization(name='batch_normalization_8', trainable=False)(conv3_4)
    conv3_4 = Activation('relu', trainable=False)(conv3_4)
    maxpool3 = MaxPooling2D((2, 2), name='block3_pool', trainable=False)(conv3_4)

    # Block 4
    conv4_1 = Conv2D(512, (3, 3), padding='same', name='block4_conv1', trainable=False)(maxpool3)
    conv4_1 = BatchNormalization(name='batch_normalization_9', trainable=False)(conv4_1)
    conv4_1 = Activation('relu', trainable=False)(conv4_1)
    conv4_2 = Conv2D(512, (3, 3), padding='same', name='block4_conv2', trainable=False)(conv4_1)
    conv4_2 = BatchNormalization(name='batch_normalization_10', trainable=False)(conv4_2)
    conv4_2 = Activation('relu', trainable=False)(conv4_2)
    conv4_3 = Conv2D(512, (3, 3), padding='same', name='block4_conv3', trainable=False)(conv4_2)
    conv4_3 = BatchNormalization(name='batch_normalization_11', trainable=False)(conv4_3)
    conv4_3 = Activation('relu', trainable=False)(conv4_3)
    conv4_4 = Conv2D(512, (3, 3), padding='same', name='block4_conv4', trainable=False)(conv4_3)
    conv4_4 = BatchNormalization(name='batch_normalization_12', trainable=False)(conv4_4)
    conv4_4 = Activation('relu', trainable=False)(conv4_4)
    maxpool4 = MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool', trainable=False)(conv4_4)

    # Block 5
    conv5_1 = Conv2D(512, (3, 3), padding='same', name='block5_conv1', trainable=True)(maxpool4)
    conv5_1 = BatchNormalization(name='batch_normalization_13', trainable=True)(conv5_1)
    conv5_1 = Activation('relu', trainable=True)(conv5_1)
    conv5_2 = Conv2D(512, (3, 3), padding='same', name='block5_conv2', trainable=True)(conv5_1)
    conv5_2 = BatchNormalization(name='batch_normalization_14', trainable=True)(conv5_2)
    conv5_2 = Activation('relu', trainable=True)(conv5_2)
    conv5_3 = Conv2D(512, (3, 3), padding='same', name='block5_conv3', trainable=True)(conv5_2)
    conv5_3 = BatchNormalization(name='batch_normalization_15', trainable=True)(conv5_3)
    conv5_3 = Activation('relu', trainable=True)(conv5_3)
    ...
    # de conv begin
    conv6_1 = Conv2D(512, (3, 3), padding='same', name='de2_conv5_1')(fuse)
    conv6_1 = BatchNormalization(name='batch_normalization_16')(conv6_1)
    conv6_1 = Activation('relu')(conv6_1)
    conv6_2 = Conv2D(512, (3, 3), padding='same', name='de2_conv5_2')(conv6_1)
    conv6_2 = BatchNormalization(name='batch_normalization_17')(conv6_2)
    conv6_2 = Activation('relu')(conv6_2)
    conv6_3 = Conv2D(512, (3, 3), padding='same', name='de2_conv5_3')(conv6_2)
    ...
    conv_m1 = Activation('relu')(conv_m1)
    conv7_1 = Conv2D(512, (3, 3), padding='same', name='de2_conv4_1')(conv_m1)
    conv7_1 = BatchNormalization(name='batch_normalization_20')(conv7_1)
    conv7_1 = Activation('relu')(conv7_1)
    conv7_2 = Conv2D(512, (3, 3), padding='same', name='de2_conv4_2')(conv7_1)
    ...
    conv_m2 = Activation('relu')(conv_m2)
    conv8_1 = Conv2D(256, (3, 3), padding='same', name='de2_conv3_1')(conv_m2)
    ...
    conv_m3 = Activation('relu')(conv_m3)
    conv9_1 = Conv2D(128, (3, 3), padding='same', name='de2_conv2_1')(conv_m3)
    ...
    # ROSA
    # biInputs=Input(input_shape)
    # outputs_crf=CrfRnnLayer(image_dims=(img_height,img_width),name='crfrnn',
    #             num_classes=2,num_iterations=5,
    #             theta_alpha=160.,theta_beta=3.,theta_gamma=3.)([outputs_all,biInputs])
    # out=Activation(activation='softmax')(outputs_crf)
    # model = Model(inputs = [inputs,inputs_deep,biInputs], outputs = [out])
    ...
    #                                         'lambda_2': tf.keras.losses.mse},
    #                   metrics={'conv2d_9': 'acc', 'lambda_1': customized_acc, 'lambda_2': customized_acc})
    #     model.summary()
    return model
...
def vgg16_deep_fuse_model(img_width,img_height):
    ...
    inputs=Input(input_shape)
    # Block 1
    conv1_1 = Conv2D(64, (3, 3), padding='same', name='block1_conv1',trainable=True)(inputs)
    conv1_1 = BatchNormalization(name='batch_normalization_1',trainable=True)(conv1_1)
    conv1_1 = Activation('relu',trainable=True)(conv1_1)
    conv1_2 = Conv2D(64, (3, 3), padding='same', name='block1_conv2',trainable=True)(conv1_1)
    conv1_2 = BatchNormalization(name='batch_normalization_2',trainable=True)(conv1_2)
    conv1_2 = Activation('relu',trainable=True)(conv1_2)

    maxpool1 = MaxPooling2D((2, 2), strides=(2, 2), name='block1_pool',trainable=True)(conv1_2)

    # Block 2
    conv2_1 = Conv2D(128, (3, 3), padding='same', name='block2_conv1',trainable=True)(maxpool1)
    conv2_1 = BatchNormalization(name='batch_normalization_3',trainable=True)(conv2_1)
    conv2_1 = Activation('relu',trainable=True)(conv2_1)
    conv2_2 = Conv2D(128, (3, 3), padding='same', name='block2_conv2',trainable=True)(conv2_1)
    conv2_2 = BatchNormalization(name='batch_normalization_4',trainable=True)(conv2_2)
    conv2_2 = Activation('relu',trainable=True)(conv2_2)
    maxpool2 = MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool',trainable=True)(conv2_2)

    # Block 3
    conv3_1 = Conv2D(256, (3, 3), padding='same',name='block3_conv1',trainable=True)(maxpool2)
    conv3_1 = BatchNormalization(name='batch_normalization_5',trainable=True)(conv3_1)
    conv3_1 = Activation('relu',trainable=True)(conv3_1)
    conv3_2 = Conv2D(256, (3, 3), padding='same', name='block3_conv2',trainable=True)(conv3_1)
    conv3_2 = BatchNormalization(name='batch_normalization_6',trainable=True)(conv3_2)
    conv3_2 = Activation('relu',trainable=True)(conv3_2)
    conv3_3 = Conv2D(256, (3, 3), padding='same', name='block3_conv3',trainable=True)(conv3_2)
    conv3_3 = BatchNormalization(name='batch_normalization_7',trainable=True)(conv3_3)
    conv3_3 = Activation('relu',trainable=True)(conv3_3)
    conv3_4 = Conv2D(256, (3, 3), padding='same', name='block3_conv4',trainable=True)(conv3_3)
    conv3_4 = BatchNormalization(name='batch_normalization_8',trainable=True)(conv3_4)
    conv3_4 = Activation('relu',trainable=True)(conv3_4)
    maxpool3 = MaxPooling2D((2, 2), name='block3_pool',trainable=True)(conv3_4)

    # Block 4
    conv4_1 = Conv2D(512, (3, 3), padding='same', name='block4_conv1',trainable=True)(maxpool3)
    conv4_1 = BatchNormalization(name='batch_normalization_9',trainable=True)(conv4_1)
    conv4_1 = Activation('relu',trainable=True)(conv4_1)
    conv4_2 = Conv2D(512, (3, 3), padding='same', name='block4_conv2',trainable=True)(conv4_1)
    conv4_2 = BatchNormalization(name='batch_normalization_10',trainable=True)(conv4_2)
    conv4_2 = Activation('relu',trainable=True)(conv4_2)
    conv4_3 = Conv2D(512, (3, 3), padding='same', name='block4_conv3',trainable=True)(conv4_2)
    conv4_3 = BatchNormalization(name='batch_normalization_11',trainable=True)(conv4_3)
    conv4_3 = Activation('relu',trainable=True)(conv4_3)
    conv4_4 = Conv2D(512, (3, 3), padding='same', name='block4_conv4',trainable=True)(conv4_3)
    conv4_4 = BatchNormalization(name='batch_normalization_12',trainable=True)(conv4_4)
    conv4_4 = Activation('relu',trainable=True)(conv4_4)
    maxpool4 = MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool',trainable=True)(conv4_4)
