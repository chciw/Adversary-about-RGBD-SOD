...
- Model
  - [PDnet](https://github.com/cai199626/PDNet)
- Attack
  - tensorflow implement of [ROSA](https://github.com/lhaof/ROSA-Robust-Salient-Object-Detection-Against-Adversarial-Attacks)
  - nontarget ML on RGBD SOD
- Defense
  - tensorflow implement of [ROSA](https://github.com/lhaof/ROSA-Robust-Salient-Object-Detection-Against-Adversarial-Attacks)
  - [Madry's Adversarial Training](https://github.com/MadryLab/cifar10_challenge) on RGBD SOD
***
...
|Transferable Sparse Adversarial Attack<br>[https://github.com/shaguopohuaizhe/TSAA](https://github.com/shaguopohuaizhe/TSAA)|preprint|a generator to decouples the sparse perturbation into amplitude and position components and optimize them jointly in an end-to-end way|black_box|
